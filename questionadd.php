...
<html>
    ...
    background-repeat: no-repeat;
     ...
     <body class="img">
         ...
         <form class="w3-container w3-card-4 w3-half w3-dark-grey" action="" method="post">
             
                <p>      
                <label class="w3-text w3-hover-text-teal" ><b>Question Description</b></label>
                <input class="w3-input w3-border w3-pale-green w3-hover-white" name="qd" type="text" required></p>
                <p>      
                <label class="w3-text w3-hover-text-teal"><b>Option 1</b></label>
                <input class="w3-input w3-border w3-pale-green w3-hover-white" name="o1" type="text" required></p>
                <p>      
                <label class="w3-text w3-hover-text-teal" ><b>Option 2</b></label>
                <input class="w3-input w3-border w3-pale-green w3-hover-white" name="o2" type="text" required></p>
                <p>      
                <label class="w3-text w3-hover-text-teal"><b>Option 3</b></label>
                <input class="w3-input w3-border w3-pale-green w3-hover-white" name="o3" type="text" required></p>
                <p>      
                <label class="w3-text w3-hover-text-teal"><b>Option 4</b></label>
                <input class="w3-input w3-border w3-pale-green w3-hover-white" name="o4" type="text" required></p>
                <p>      
                <label class="w3-text w3-hover-text-teal"><b>True Answer</b></label>
                <input class="w3-input w3-border w3-pale-green w3-hover-white" name="ta" type="text" required></p>
    ...
    // output data of each row
                ...
                echo "<tr align=center class='w3-text-white'><td>".$row["course_id"]."</td><th>
